...
@hunterx.on(admin_cmd(pattern="sin ?(.*)"))
@hunterx.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@hunterx.on(admin_cmd(pattern="cos ?(.*)"))
@hunterx.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@hunterx.on(admin_cmd(pattern="tan ?(.*)"))
@hunterx.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@hunterx.on(admin_cmd(pattern="cosec ?(.*)"))
@hunterx.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@hunterx.on(admin_cmd(pattern="sec ?(.*)"))
@hunterx.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@hunterx.on(admin_cmd(pattern="cot ?(.*)"))
@hunterx.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@hunterx.on(admin_cmd(pattern="square ?(.*)"))
@hunterx.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@hunterx.on(admin_cmd(pattern="cube ?(.*)"))
@hunterx.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
